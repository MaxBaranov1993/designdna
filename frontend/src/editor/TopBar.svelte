...
<div class="fe-toolbar">
  ...
  <button class="fe-tbtn" data-act="zoom-out" title="Уменьшить" onclick={() => ctl.handleAct("zoom-out")}>−</button>
  <span class="fe-zoom" bind:this={zoomLabel}>100%</span>
  <button class="fe-tbtn" data-act="zoom-in" title="Увеличить" onclick={() => ctl.handleAct("zoom-in")}>+</button>
  <button class="fe-tbtn" data-act="zoom-fit" title="Вписать" onclick={() => ctl.handleAct("zoom-fit")}>⊡</button>
  <span class="fe-sep"></span>
  <span class="fe-viewports" hidden bind:this={viewports}>
    <button class="fe-tbtn fe-viewport-btn active" data-viewport="desktop" title="Desktop 1440 px" onclick={() => ctl.setViewport("desktop")}>
    ...
    <button class="fe-tbtn fe-viewport-btn" data-viewport="tablet" title="Tablet 768 px" onclick={() => ctl.setViewport("tablet")}>
    ...
    <button class="fe-tbtn fe-viewport-btn" data-viewport="mobile" title="Mobile 390 px" onclick={() => ctl.setViewport("mobile")}>
  ...
  <button class="fe-btn danger" data-act="close" onclick={() => ctl.handleAct("close")}>Закрыть</button>
  <button class="fe-btn primary" data-act="save" onclick={() => ctl.handleAct("save")}>💾 Сохранить</button>
</div>
