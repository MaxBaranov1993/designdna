...
- Отсутствие slop-тропов — 15: нет шаблонной россыпи одинаковых карточек, бессмысленных градиентов, pill на каждом элементе, декоративных метрик без содержания, пустых заглушек и повторов.
