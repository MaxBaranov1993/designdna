...
def analyze_structure(image_b64: str, provider: str, llm_module) -> dict:
    """VLM-анализ структуры скриншота через GPT Codex роль reproduce."""
    prompt = (
...
def run_pipeline(image_b64: str, provider: str = "codex", llm_module=None,
                 regions: list | None = None) -> dict:
    """Полный пайплайн pixel-perfect reproduction.

    1. VLM-анализ структуры через GPT Codex
