#!/usr/bin/env python3
"""Пакетный прогон спайка: 7 брифов × 2 провайдера × 3 прогона.
...
# qwen — 3 температуры; kimi k3 принимает только T=1 → 3 повтора для оценки разброса
RUNS = {
    "qwen": [("t07", 0.7), ("t09", 0.9), ("t10", 1.0)],
    "kimi": [("r1", 1.0), ("r2", 1.0), ("r3", 1.0)],
}
